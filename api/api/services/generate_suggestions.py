...
And include an XML tag "misinterpretation" describing, in detail, how ONLY the figurative portion of the message can be realistically misinterpreted in a literal sense.
